...
import { createAPI, deleteAPI } from '../../../Redux/Actions/ActivePharmaAction';
            ...
            <div className="row">
              <div className="col-md-8">
                <Form.Group controlId="formBasicText">
                  <Form.Control type="text" placeholder="Nhập hoạt chất thuốc" value={itemName} onChange={e => setItemName(e.target.value)}/>
                </Form.Group>
              </div>
